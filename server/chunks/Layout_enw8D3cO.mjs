import { A as renderTemplate, B as createAstro, D as renderSlot, M as renderHead, N as addAttribute, P as createRenderInstruction, R as unescapeHTML, T as Fragment$2, j as maybeRenderHead, w as renderComponent } from "./sequence_CwpToexC.mjs";
import { t as createComponent } from "./compiler_BgboG8oT.mjs";
import { C as siteConfig, c as referenceCases } from "./services_D6I65Rsy.mjs";
import { n as isExcluded } from "./sitemap_D1DGtGlM.mjs";
...
//#endregion
//#region node_modules/@fontsource/lato/files/lato-latin-400-normal.woff2?url
var lato_latin_400_normal_default = "/_astro/lato-latin-400-normal.BEhtfm5r.woff2";
//#endregion
...
function SmoothScroll() {
	useEffect(() => {
		const prefersReduce = () => window.matchMedia("(prefers-reduced-motion: reduce)").matches || document.documentElement.hasAttribute("data-a11y-motion");
...
function CustomCursor() {
	...
	useEffect(() => {
		...
		const reduce = window.matchMedia("(prefers-reduced-motion: reduce)").matches || document.documentElement.hasAttribute("data-a11y-motion");
...
//#endregion
//#region src/components/A11yTools.astro
createAstro("https://tracht-digital.de");
var $$A11yTools = createComponent(($$result, $$props, $$slots) => {
	const Astro = $$result.createAstro($$props, $$slots);
	Astro.self = $$A11yTools;
	const copy = resolveLang(Astro.currentLocale) === "en" ? {
		...
		open: "Einstellungen zur Barrierefreiheit",
		title: "Barrierefreiheit",
		text: "Größere Schrift",
		contrast: "Hoher Kontrast",
		motion: "Bewegung aus",
		note: "Wird auf diesem Gerät gespeichert.",
		close: "Schließen"
	};
	const toggles = [
		{
	...
	return renderTemplate`${maybeRenderHead($$result)}<button type="button" class="a11y-toggle" popovertarget="a11y-panel"${addAttribute(copy.open, "aria-label")} data-a11y-open hidden data-astro-cid-jzswpfjk><svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-jzswpfjk><circle cx="12" cy="4.5" r="1.75" data-astro-cid-jzswpfjk></circle><path d="M5 8.5l7 1.5 7-1.5" data-astro-cid-jzswpfjk></path><path d="M12 10v4.5" data-astro-cid-jzswpfjk></path><path d="M9 21l3-6.5 3 6.5" data-astro-cid-jzswpfjk></path></svg></button><div id="a11y-panel" popover class="a11y-panel" role="dialog" aria-labelledby="a11y-panel-title" data-astro-cid-jzswpfjk><div class="a11y-panel__head" data-astro-cid-jzswpfjk><p id="a11y-panel-title" class="a11y-panel__title" data-astro-cid-jzswpfjk>${copy.title}</p><button type="button" class="a11y-panel__close" popovertarget="a11y-panel" popovertargetaction="hide" data-astro-cid-jzswpfjk><span class="sr-only" data-astro-cid-jzswpfjk>${copy.close}</span><svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-jzswpfjk><line x1="6" y1="6" x2="18" y2="18" data-astro-cid-jzswpfjk></line><line x1="18" y1="6" x2="6" y2="18" data-astro-cid-jzswpfjk></line></svg></button></div><ul class="a11y-panel__list" data-astro-cid-jzswpfjk>${toggles.map((toggle) => renderTemplate`<li data-astro-cid-jzswpfjk><button type="button" class="a11y-switch" aria-pressed="false"${addAttribute(toggle.pref, "data-a11y-pref")} data-astro-cid-jzswpfjk><span class="a11y-switch__label" data-astro-cid-jzswpfjk>${toggle.label}</span><span class="a11y-switch__track" aria-hidden="true" data-astro-cid-jzswpfjk><span class="a11y-switch__thumb" data-astro-cid-jzswpfjk></span></span></button></li>`)}</ul><p class="a11y-panel__note" data-astro-cid-jzswpfjk>${copy.note}</p></div>${renderScript($$result, "/home/runner/work/tds-landingpage-frontend/tds-landingpage-frontend/src/components/A11yTools.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/runner/work/tds-landingpage-frontend/tds-landingpage-frontend/src/components/A11yTools.astro", void 0);
//#endregion
...
var $$FloatingCta = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${maybeRenderHead($$result)}<aside class="floating-cta-group"${addAttribute(regionLabel, "aria-label")} data-scrolled-down="false" data-astro-cid-72f5watn><div class="tree-slot tree-slot--top" data-astro-cid-72f5watn><div class="tree-slot__inner" data-astro-cid-72f5watn><button type="button" class="floating-cta-top"${addAttribute(topLabel, "aria-label")} data-astro-cid-72f5watn><svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="tree-icon" data-astro-cid-72f5watn><line x1="12" y1="19" x2="12" y2="5" data-astro-cid-72f5watn></line><polyline points="5 12 12 5 19 12" data-astro-cid-72f5watn></polyline></svg></button></div></div><div class="tree-slot tree-slot--a11y" data-astro-cid-72f5watn><div class="tree-slot__inner" data-astro-cid-72f5watn>${renderComponent($$result, "A11yTools", $$A11yTools, { "data-astro-cid-72f5watn": true })}</div></div><div class="tree-slot tree-slot--trunk" data-astro-cid-72f5watn><div class="tree-slot__inner" data-astro-cid-72f5watn><a${addAttribute(href, "href")} class="floating-cta"${addAttribute(label, "aria-label")} data-astro-cid-72f5watn><svg aria-hidden="true" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" class="tree-icon floating-cta__icon" data-astro-cid-72f5watn><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" data-astro-cid-72f5watn></path></svg></a></div></div><span aria-hidden="true" class="floating-cta__hint" data-astro-cid-72f5watn>${hint}</span></aside>${renderScript($$result, "/home/runner/work/tds-landingpage-frontend/tds-landingpage-frontend/src/components/FloatingCta.astro?astro&type=script&index=0&lang.ts")}`;
...
function propertyLinks(lang) {
	return [
		{
			id: "journal",
			label: "Journal",
			href: propertyHome("journal", lang)
		},
		{
			id: "tools",
			label: "Tools",
			href: propertyHome("tools", lang)
		},
		{
			id: "portal",
			label: lang === "de" ? "Kundenportal" : "Customer portal",
			href: siteConfig.portalUrl
		},
		{
			id: "shop",
			label: "Shop",
			href: propertyHome("shop", lang)
		}
	];
}
//#endregion
//#region src/components/PropertyTabs.astro
createAstro("https://tracht-digital.de");
var $$PropertyTabs = createComponent(($$result, $$props, $$slots) => {
	const Astro = $$result.createAstro($$props, $$slots);
	Astro.self = $$PropertyTabs;
	const lang = resolveLang(Astro.currentLocale);
	...
	const ICONS = {
		journal: ["M2 4h6a4 4 0 0 1 4 4v12a3 3 0 0 0-3-3H2z", "M22 4h-6a4 4 0 0 0-4 4v12a3 3 0 0 1 3-3h7z"],
	...
	return renderTemplate`${maybeRenderHead($$result)}<nav class="property-tabs"${addAttribute(navLabel, "aria-label")} data-property-tabs data-astro-cid-f3l3wxva><ul class="property-tabs__list" data-astro-cid-f3l3wxva>${links.map((link) => renderTemplate`<li data-astro-cid-f3l3wxva><a${addAttribute(link.href, "href")} class="property-tab"${addAttribute(link.id, "data-property-tab")} rel="noopener" data-astro-cid-f3l3wxva><span class="property-tab__label" data-astro-cid-f3l3wxva>${link.label}<span class="sr-only" data-astro-cid-f3l3wxva> ${external}</span></span><span aria-hidden="true" class="property-tab__arrow" data-astro-cid-f3l3wxva>↗</span><svg aria-hidden="true" class="property-tab__icon" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-f3l3wxva>${ICONS[link.id].map((d) => renderTemplate`<path${addAttribute(d, "d")} data-astro-cid-f3l3wxva></path>`)}</svg></a></li>`)}</ul></nav>${renderScript($$result, "/home/runner/work/tds-landingpage-frontend/tds-landingpage-frontend/src/components/PropertyTabs.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/runner/work/tds-landingpage-frontend/tds-landingpage-frontend/src/components/PropertyTabs.astro", void 0);
//#endregion
...
//#endregion
//#region src/lib/motion/constants.ts
/**
...
*/
var PAGE_ENTER_ATTR = "data-page-enter";
var PAGE_EXIT_KEY = "lp-page-exit";
/**
...
*/
var PAGE_ENTER_SCRIPT = `try{if(sessionStorage.getItem("${PAGE_EXIT_KEY}")){sessionStorage.removeItem("${PAGE_EXIT_KEY}");if(!matchMedia("(prefers-reduced-motion: reduce)").matches&&!document.documentElement.hasAttribute("data-a11y-motion"))document.documentElement.setAttribute("${PAGE_ENTER_ATTR}","")}}catch(e){}`;
//#endregion
//#region src/lib/a11yPrefs.ts
/**
...
*/
var A11Y_STORAGE_KEY = "lp-a11y";
var A11Y_PREFS = [
	"text",
	"contrast",
	"motion"
];
var a11yAttr = (pref) => `data-a11y-${pref}`;
/** Inline in `<head>`, before anything paints. No imports — it is a string. */
var A11Y_BOOT_SCRIPT = `try{var p=JSON.parse(localStorage.getItem("${A11Y_STORAGE_KEY}")||"{}"),r=document.documentElement;${A11Y_PREFS.map((pref) => `if(p.${pref}===true)r.setAttribute("${a11yAttr(pref)}","");`).join("")}}catch(e){}`;
//#endregion
...
var $$Layout = createComponent(async ($$result, $$props, $$slots) => {
	...
	return renderTemplate`<!-- data-surface selects the geometry layer from tds-shared's design
     ...
     700 display voice. Do not author radii locally. --><html${addAttribute(lang, "lang")} data-surface="marketing"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><script>${unescapeHTML(A11Y_BOOT_SCRIPT)}<\/script><script>${unescapeHTML(PAGE_ENTER_SCRIPT)}<\/script><link rel="preload"${addAttribute(lato_latin_400_normal_default, "href")} as="font" type="font/woff2" crossorigin><meta name="description"${addAttribute(description, "content")}><meta name="generator"${addAttribute(Astro.generator, "content")}><meta name="theme-color" content="#050f68" media="(prefers-color-scheme: light)"><meta name="theme-color" content="#0b0a07" media="(prefers-color-scheme: dark)"><script>${unescapeHTML(themeBootstrapScript)}<\/script>${hidden && renderTemplate`<meta name="robots" content="noindex,nofollow">`}<link rel="icon" type="image/png" href="/favicon.png" sizes="any"><link rel="canonical"${addAttribute(url, "href")}><!-- Resource hints — connect to the API origins we know we'll
		...
		"client:component-export": "default"
	})}`}${renderSlot($$result, $$slots["default"])}${!bare && renderTemplate`${renderComponent($$result, "FloatingCta", $$FloatingCta, {})}`}${!bare && renderTemplate`${renderComponent($$result, "PropertyTabs", $$PropertyTabs, {})}`}${showCookieNotice && renderTemplate`${renderComponent($$result, "ConsentBanner", ConsentBanner, {
		"client:idle": true,
		"lang": lang,
	...
	})}`}${renderScript($$result, "/home/runner/work/tds-landingpage-frontend/tds-landingpage-frontend/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts")}${renderScript($$result, "/home/runner/work/tds-landingpage-frontend/tds-landingpage-frontend/src/layouts/Layout.astro?astro&type=script&index=1&lang.ts")}${renderScript($$result, "/home/runner/work/tds-landingpage-frontend/tds-landingpage-frontend/src/layouts/Layout.astro?astro&type=script&index=2&lang.ts")}</body></html>`;
}, "/home/runner/work/tds-landingpage-frontend/tds-landingpage-frontend/src/layouts/Layout.astro", void 0);
//#endregion
export { coverVariant as a, transitions as c, sectionLinks as d, localizePath as f, renderScript as g, translations as h, ThemeToggle as i, runtimeSetting as l, tFor as m, ConsentLink as n, hasPhotoCover as o, resolveLang as p, AbstractCover as r, presence as s, $$Layout as t, propertyLinks as u };
