import { A as renderTemplate, B as createAstro, D as renderSlot, M as renderHead, N as addAttribute, P as createRenderInstruction, R as unescapeHTML, T as Fragment$2, j as maybeRenderHead, w as renderComponent } from "./sequence_BMhx82Vm.mjs";
import { t as createComponent } from "./compiler_CXeQXDPg.mjs";
import { S as siteConfig } from "./services_DUi7CG0t.mjs";
import { n as isExcluded } from "./sitemap_CUxUWmo2.mjs";
...
//#endregion
//#region node_modules/@tracht-digital-solutions/tds-shared/dist/chunk-HNOIBUNB.js
var ease = [
	.2,
	.8,
	.2,
...
var $$Layout = createComponent(async ($$result, $$props, $$slots) => {
	...
	return renderTemplate`<!-- data-surface selects the geometry layer from tds-shared's design
     ...
     700 display voice. Do not author radii locally. --><html${addAttribute(lang, "lang")} data-surface="marketing"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="description"${addAttribute(description, "content")}><meta name="generator"${addAttribute(Astro.generator, "content")}><meta name="theme-color" content="#050f68" media="(prefers-color-scheme: light)"><meta name="theme-color" content="#0b0a07" media="(prefers-color-scheme: dark)"><script>${unescapeHTML(themeBootstrapScript)}<\/script>${hidden && renderTemplate`<meta name="robots" content="noindex,nofollow">`}<link rel="icon" type="image/png" href="/favicon.png" sizes="any"><link rel="canonical"${addAttribute(url, "href")}><!-- Resource hints — connect to the API origins we know we'll
		...
		"client:component-export": "default"
	})}`}${renderSlot($$result, $$slots["default"])}${!bare && renderTemplate`${renderComponent($$result, "FloatingCta", $$FloatingCta, {})}`}${showCookieNotice && renderTemplate`${renderComponent($$result, "ConsentBanner", ConsentBanner, {
		"client:idle": true,
		"lang": lang,
...
//#endregion
export { coverVariant as a, transitions as c, resolveLang as d, tFor as f, ThemeToggle as i, runtimeSetting as l, renderScript as m, ConsentLink as n, hasPhotoCover as o, translations as p, AbstractCover as r, presence as s, $$Layout as t, localizePath as u };
