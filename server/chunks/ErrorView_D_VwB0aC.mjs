import { A as renderTemplate, B as createAstro, D as renderSlot, N as addAttribute, T as Fragment, j as maybeRenderHead, w as renderComponent } from "./sequence_BMhx82Vm.mjs";
import { t as createComponent } from "./compiler_CXeQXDPg.mjs";
import { d as resolveLang, t as $$Layout, u as localizePath } from "./Layout_B749k1M0.mjs";
import { S as siteConfig, f as JOURNAL_ARTICLES, h as platformHref, l as referencesForPlatform, m as platformDefinitions, o as serviceHref, s as articleUrl, t as getServiceById, u as cmsFor, y as businessCardCopy } from "./services_CP3nOvK5.mjs";
import { l as webPageNode, n as breadcrumbNode, r as faqPageSchema, s as serviceNode, t as asGraph } from "./jsonld_BLodLwid.mjs";
import { a as $$BusinessCardTile, b as $$Footer, c as $$FirstCall, d as getReferencePreviewsBySiteUrl, f as $$ServiceCard, g as getHomeContent, h as demosCopy, l as $$CardActions, n as getPricingContent, o as $$DemoCard, p as $$SectionHeader, r as getServiceRate, s as getDemos, t as $$FaqAccordion, v as $$Emphasis, x as $$Header, y as stripEmphasis } from "./FaqAccordion_BrkwxAia.mjs";
...
var $$DetailHero = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${maybeRenderHead($$result)}<section class="tds-wash tds-wash--calm relative overflow-hidden pt-36 pb-20 md:pt-44 md:pb-28" aria-labelledby="service-title" data-astro-cid-cepj5mfo><div class="tds-decor" aria-hidden="true" data-astro-cid-cepj5mfo>${image && renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result) => renderTemplate`<img${addAttribute(image, "src")} alt="" aria-hidden="true" fetchpriority="low" decoding="async" class="service-hero__photo absolute inset-0 h-full w-full object-cover" data-astro-cid-cepj5mfo><span class="absolute inset-0 bg-[linear-gradient(to_right,var(--color-paper)_20%,color-mix(in_srgb,var(--color-paper)_82%,transparent)_60%,color-mix(in_srgb,var(--color-paper)_58%,transparent)_100%)]" data-astro-cid-cepj5mfo></span>` })}`}<span class="tds-shape tds-shape--quarter-tl tds-shape--bordeaux" style="right: -8rem; bottom: -11rem; width: 29rem; height: 29rem; --tds-decor-shape-alpha: 0.13;" data-astro-cid-cepj5mfo></span><span class="tds-shape tds-shape--rect tds-shape--outline tds-shape--navy hidden lg:block" style="right: 8%; top: 8rem; width: 12rem; height: 18rem; --tds-decor-shape-alpha: 0.2;" data-astro-cid-cepj5mfo></span></div><div class="relative max-w-7xl mx-auto px-6 md:px-8 lg:px-12" data-astro-cid-cepj5mfo><nav${addAttribute(navLabel, "aria-label")} class="mb-10" data-astro-cid-cepj5mfo><a${addAttribute(backHref, "href")} class="inline-flex items-center gap-2 text-sm text-[var(--color-muted)] hover:text-[var(--color-primary)] transition-colors group [@media(pointer:coarse)]:min-h-11" data-astro-cid-cepj5mfo><svg aria-hidden="true" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="transition-transform group-hover:-translate-x-0.5" data-astro-cid-cepj5mfo><line x1="19" y1="12" x2="5" y2="12" data-astro-cid-cepj5mfo></line><polyline points="12 19 5 12 12 5" data-astro-cid-cepj5mfo></polyline></svg>${backLabel}</a></nav><div class="max-w-4xl" data-astro-cid-cepj5mfo><h1 id="service-title" class="display text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-[var(--color-black)] leading-[1.04] break-words mb-6" data-astro-cid-cepj5mfo>${title}</h1><span aria-hidden="true" class="tds-brandbar mb-8" data-astro-cid-cepj5mfo></span><p class="lead max-w-3xl text-[var(--color-muted)] mb-9" data-astro-cid-cepj5mfo>${lead}</p><a${addAttribute(ctaHref, "href")} class="btn btn-primary group" data-astro-cid-cepj5mfo>${ctaLabel}<svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="transition-transform group-hover:translate-x-0.5" data-astro-cid-cepj5mfo><line x1="5" y1="12" x2="19" y2="12" data-astro-cid-cepj5mfo></line><polyline points="12 5 19 12 12 19" data-astro-cid-cepj5mfo></polyline></svg></a>${renderSlot($$result, $$slots["default"])}</div></div></section>`;
...
var $$DetailCta = createComponent(($$result, $$props, $$slots) => {
	...
	return renderTemplate`${maybeRenderHead($$result)}<div class="pb-16 md:pb-24 px-6 md:px-8 lg:px-12"><section class="tds-tone-navy relative overflow-hidden max-w-7xl mx-auto rounded-[6px] px-7 py-12 md:px-12 md:py-16 text-center" aria-labelledby="service-cta-title"><span aria-hidden="true" class="tds-shape tds-shape--quarter-tr tds-shape--coral" style="left: -5rem; bottom: -6rem; width: 18rem; height: 18rem; --tds-decor-shape-alpha: 0.18;"></span><div class="relative max-w-3xl mx-auto"><h2 id="service-cta-title" class="display text-3xl md:text-5xl text-white mb-5">${title}</h2><p class="text-white/75 leading-relaxed max-w-2xl mx-auto mb-8">${text}</p><div class="mb-8">${renderComponent($$result, "FirstCall", $$FirstCall, { "variant": "service" })}</div><a${addAttribute(href, "href")} class="inline-flex items-center gap-2 bg-white text-[var(--color-surface-navy)] px-7 py-3.5 rounded-[100px] text-sm font-medium hover:bg-white/85 transition-colors group">${buttonLabel}<svg aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="transition-transform group-hover:translate-x-0.5"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></a></div></section></div>`;
...
var $$DetailFaq = createComponent(($$result, $$props, $$slots) => {
	...
	const { title, items, tone = "sand" } = Astro.props;
	return renderTemplate`${maybeRenderHead($$result)}<div${addAttribute(["section-spacing", tone === "sand" && "tds-tone-sand"], "class:list")}><section class="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 grid gap-8 lg:grid-cols-[minmax(0,22rem)_minmax(0,1fr)] lg:gap-16 lg:items-start" aria-labelledby="platform-faq-title"><h2 id="platform-faq-title" class="display text-3xl md:text-4xl text-[var(--color-black)]">${title}</h2><div class="grid gap-1">${renderComponent($$result, "FaqAccordion", $$FaqAccordion, {
		"items": items,
		"name": "platform-faq"
	})}</div></section></div>`;
...
var $$DetailRelated = createComponent(($$result, $$props, $$slots) => {
	...
	const { title, parentTitle, parent, platformsTitle, platforms, articlesTitle, articles, tone = "paper" } = Astro.props;
	const fill = tone === "sand" ? "bg-[var(--lp-surface-card)]" : "bg-[var(--color-soft)]";
	const groups = [
		{
			title: parentTitle,
			links: [parent]
