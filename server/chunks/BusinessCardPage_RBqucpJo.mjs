import { A as renderTemplate, B as createAstro, N as addAttribute, R as unescapeHTML, j as maybeRenderHead, w as renderComponent } from "./sequence_CwpToexC.mjs";
import { t as createComponent } from "./compiler_BgboG8oT.mjs";
import { g as renderScript, i as ThemeToggle, m as tFor, t as $$Layout } from "./Layout_enw8D3cO.mjs";
import { C as siteConfig, S as businessCardLinks, v as BUSINESS_CARD_QR_PATH, x as businessCardHref } from "./services_D6I65Rsy.mjs";
import { a as personSchema, b as portraitSrc, h as PORTRAIT_SIZE, t as asGraph, x as portraitSrcset } from "./jsonld_3kdu1TYW.mjs";
import { t as legalCopy } from "./legal_8tQTbIFr.mjs";
...
var $$BusinessCardPage = createComponent(($$result, $$props, $$slots) => {
	...
	const ui = lang === "de" ? {
		...
		bio: "Dein fester Ansprechpartner für Website, Onlineshop und Digitalisierung.",
		...
		pitchTitle: "So eine Karte für dein Unternehmen?",
		pitchText: "Diese Karte gehört zum Webauftritt: eine Adresse, die auf jedem Handy funktioniert und sich jederzeit ändern lässt.",
		pitchCta: "Zum Webauftritt"
	} : {
		eyebrow: "Digital business card",
		bio: "Your steady point of contact for websites, online shops and digitalization.",
		save: "Save contact",
		...
		pitchText: "This card is part of a web presence: one address that works on every phone and can be changed at any time.",
