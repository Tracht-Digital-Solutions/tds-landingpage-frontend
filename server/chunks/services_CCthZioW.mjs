import { n as assertKeyAccepted, r as siteKeyHeaders, t as contentCache } from "./contentCache_C2sWg_72.mjs";
...
var serviceDefinitions = [
	{
		...
		fallback: {
			de: {
				...
				title: "Webauftritt",
				summary: "Bestehende Website oder Shop übernehmen, reparieren und pflegen – oder neu bauen, wenn sich das nicht mehr lohnt.",
				intro: "Meistens muss nichts neu gebaut werden. Ich übernehme, *was trägt* – und ersetze nur, was sich nicht mehr retten lässt.",
				situationsTitle: "Kommt dir das bekannt vor?",
				situations: [
			...
			en: {
				label: "All services",
				title: "Web Presence",
				summary: "Taking over, repairing and maintaining an existing website or shop – or building new where that no longer pays off.",
				intro: "Usually nothing has to be rebuilt. I take over *what holds up* – and replace only what cannot be saved.",
				situationsTitle: "Does this sound familiar?",
				situations: [
	...
	},
	{
		...
		fallback: {
			de: {
				...
				summary: "Ich schaue mir deine täglichen Abläufe an, streiche unnötige Schritte und automatisiere, was spürbar Zeit spart.",
			...
			en: {
				...
				summary: "I look at your day-to-day workflows, remove the steps nobody needs and automate what noticeably saves time.",
...
//#endregion
export { siteConfig as C, businessCardLinks as S, BUSINESS_CARD_PREVIEW as _, serviceDefinitions as a, businessCardCopy as b, referenceCases as c, fetchBlocks as d, hasBannedWord as f, platformHref as g, platformDefinitions as h, retiredServiceTarget as i, referencesForPlatform as l, getPlatformBySlug as m, getServiceBySlug as n, serviceHref as o, JOURNAL_ARTICLES as p, resolveServiceContent as r, articleUrl as s, getServiceById as t, cmsFor as u, BUSINESS_CARD_QR_PATH as v, businessCardHref as x, BUSINESS_CARD_SLUG as y };
