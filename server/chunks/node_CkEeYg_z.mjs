...
import { $ as UnsupportedImageFormat, A as MissingGetFontFileRequestUrl, F as NoImageMetadata, Q as UnsupportedImageConversion, T as LocalImageUsedWrongly, W as RemoteImageNotAllowed, b as IncompatibleDescriptorOptions, d as ExpectedNotESMImage, f as FailedToFetchRemoteImageDimensions, j as MissingImageDimension, l as ExpectedImage, p as FontFamilyNotFound, t as AstroError, u as ExpectedImageOptions, w as InvalidImageService, y as ImageMissingAlt } from "./errors_C4gkYgY_.mjs";
import { A as renderTemplate, B as createAstro, N as addAttribute, R as unescapeHTML, _t as joinPaths, bt as removeQueryString, c as createConsoleLogger, gt as isRemotePath, ht as isParentDirectory, j as maybeRenderHead, x as spreadAttributes } from "./sequence_BMhx82Vm.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_DJEGTxxQ.mjs").catch((e) => {
