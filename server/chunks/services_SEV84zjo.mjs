import { n as assertKeyAccepted, r as siteKeyHeaders, t as contentCache } from "./contentCache_CZmMlG-J.mjs";
import { i as contentApiBase } from "./connection_CMM0L0ms.mjs";
...
var serviceDefinitions = [
	{
		...
		fallback: {
			de: {
				...
				priceLabel: "Preis",
				priceText: "75 € netto pro Stunde. Für ein klar abgegrenztes Konzept ist nach der Bestandsaufnahme auch ein Festpreis möglich.",
			...
			en: {
				...
				priceLabel: "Price",
				priceText: "€75 net per hour. For a clearly bounded concept, a fixed price is possible after the initial assessment.",
	...
	},
	{
		...
		fallback: {
			de: {
				...
				priceLabel: "Preis",
				priceText: "70 € netto pro Stunde. Ein Festpreis ist möglich, sobald Ablauf, Datenquellen und Ziel klar sind.",
				referencesLabel: "Veröffentlicht wird nur nach ausdrücklicher Freigabe — anonymisiert, sofern nicht anders vereinbart.",
				referencesHeadline: "Einblicke aus der Praxis",
				references: [],
			...
			en: {
				...
				priceLabel: "Price",
				priceText: "€70 net per hour. A fixed price is possible once the workflow, the data sources and the goal are clear.",
				referencesLabel: "Published only with the client's explicit approval — anonymised unless agreed otherwise.",
				referencesHeadline: "Examples from practice",
				references: [],
	...
	},
	{
		...
		fallback: {
			de: {
				...
				priceLabel: "Preis",
				priceText: "70 € netto pro Stunde. Steht der Umfang fest, sind Festpreise für einzelne Etappen oder das ganze Paket möglich.",
				referencesLabel: "Veröffentlicht wird nur nach ausdrücklicher Freigabe — anonymisiert, sofern nicht anders vereinbart.",
				referencesHeadline: "Einblicke aus der Praxis",
				references: [],
			...
			en: {
				...
				priceLabel: "Price",
				priceText: "€70 net per hour. Once the scope is set, fixed prices are possible for single stages or the whole package.",
				referencesLabel: "Published only with the client's explicit approval — anonymised unless agreed otherwise.",
				referencesHeadline: "Examples from practice",
				references: [],
...
//#endregion
export { siteConfig as _, serviceDefinitions as a, referenceCases as c, BUSINESS_CARD_PREVIEW as d, BUSINESS_CARD_QR_PATH as f, businessCardLinks as g, businessCardHref as h, retiredServiceTarget as i, cmsFor as l, businessCardCopy as m, getServiceBySlug as n, serviceHref as o, BUSINESS_CARD_SLUG as p, resolveServiceContent as r, articleUrl as s, getServiceById as t, fetchBlocks as u };
