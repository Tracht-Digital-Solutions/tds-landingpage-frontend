...
import { A as renderTemplate, B as createAstro, N as addAttribute, R as unescapeHTML, _t as joinPaths, bt as removeQueryString, c as createConsoleLogger, gt as isRemotePath, ht as isParentDirectory, j as maybeRenderHead, x as spreadAttributes } from "./sequence_CrsIaRJD.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_Cumczm-u.mjs").catch((e) => {
