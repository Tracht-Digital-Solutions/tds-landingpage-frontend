...
const defaults: Record<Lang, PricingContent> = {
  de: {
    ...
    teaserSub:
      "Ab 85 € netto pro Stunde. Steht der Umfang vorher fest, rechne ich auch zum Festpreis ab.",
  ...
  en: {
    ...
    teaserSub:
      "From €85 net per hour. When the scope is settled up front, I work to a fixed price too.",
